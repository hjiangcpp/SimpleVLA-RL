...
EXPERIMENT_NAME='test1_lr5e-6_bs4_node1_lora_minimal' 
...
echo "Starting training with MINIMAL LoRA configuration..."
echo "Using rank=1 LoRA for absolute minimum memory usage"
