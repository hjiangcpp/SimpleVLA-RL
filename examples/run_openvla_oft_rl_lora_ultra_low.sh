...
EXPERIMENT_NAME='test1_lr5e-6_bs16_node1_lora_ultra_low' 
...
echo "Starting training with ULTRA LOW LoRA configuration..."
echo "Using rank=4 LoRA for maximum memory savings"
