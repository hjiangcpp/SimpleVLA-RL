...
# 在训练前清理内存
echo "=== 清理GPU内存 ==="
python3 /home/hhjiang/Documents/SimpleVLA-RL/scripts/memory_cleanup.py

export NCCL_DEBUG=WARN 
export WANDB_API_KEY=''
# 终极内存优化
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True,max_split_size_mb:4
...
EXPERIMENT_NAME='test1_lr5e-6_bs1_node1_ultimate_low' 
...
echo "Starting training with ULTIMATE low memory configuration..."
echo "This configuration uses the absolute minimum memory possible"

# 再次清理内存
python3 -c "import torch; torch.cuda.empty_cache(); print('Final GPU cache clear')"
