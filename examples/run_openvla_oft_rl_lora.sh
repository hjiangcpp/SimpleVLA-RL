...
EXPERIMENT_NAME='test1_lr5e-6_bs32_node1_lora' 
...
echo "Starting training with LoRA configuration..."
echo "LoRA will significantly reduce memory usage by only training adapter layers"
