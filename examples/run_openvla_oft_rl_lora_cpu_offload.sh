...
# CPU卸载配置
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True,max_split_size_mb:2
export TOKENIZERS_PARALLELISM=false
export CUDA_LAUNCH_BLOCKING=1
export TORCH_USE_CUDA_DSA=1

PROJECT_NAME='SimpleVLA-RL'
EXPERIMENT_NAME='test1_lr5e-6_bs2_node1_lora_cpu_offload' 
...
echo "Starting training with LoRA + CPU offload configuration..."
...
HYDRA_FULL_ERROR=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.lora_alpha=1 \
